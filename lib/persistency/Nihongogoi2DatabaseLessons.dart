...
class nihongogoin5DatabaseLessons{
  ...
  Future<bool> open() async{
    ...
    String dbPathEnglish =  join(applicationDirectory.path, "nihongo_goi_lessons.db");
    String url = "https://github.com/Bardo91/nihongo_goi_n5/raw/master/assets/nihongo_goi_lessons.db";
